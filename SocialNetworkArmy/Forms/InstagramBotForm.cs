...
namespace SocialNetworkArmy.Forms
{
    public partial class InstagramBotForm : Form
    {
        ...
        // ✅ REMPLACER dans InstagramBotForm.cs - LoadBrowserAsync()
                ...
                string[] realUserAgents = new[]
 {
    ...
    "Mozilla/5.0 (Windows NT 11.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36"
                ...
                string igDid = Guid.NewGuid().ToString().ToUpper(); // ✅ AJOUT
                await webView.CoreWebView2.AddScriptToExecuteOnDocumentCreatedAsync($@"
localStorage.setItem('ig_did', '{igDid}');
localStorage.setItem('ig_nrcb', '1');
");
                await webView.CoreWebView2.CallDevToolsProtocolMethodAsync(
    "Network.setExtraHTTPHeaders",
    "{\"headers\": {\"Accept-Language\": \"en-US,en;q=0.9\"}}"
);
                // ✅ CRITIQUE : Script AVANT tout chargement (AddScriptToExecuteOnDocumentCreatedAsync)
                await webView.CoreWebView2.AddScriptToExecuteOnDocumentCreatedAsync(GetStealthScript());

                webView.CoreWebView2.Settings.AreDefaultContextMenusEnabled = true;
                webView.CoreWebView2.Settings.IsScriptEnabled = true;
                webView.CoreWebView2.Settings.AreDevToolsEnabled = false; // ✅ Désactiver devtools
                ...
                logTextBox.AppendText("[INFO] ✓ Stealth mode active\r\n");
            }
            catch (Exception ex)
            {
        ...
        // ✅ NOUVEAU : Script stealth ultra-complet
        // REMPLACER la méthode GetStealthScript() dans InstagramBotForm.cs
